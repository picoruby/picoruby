...
#   kb.layer_names                          => [:default, :fn1, ...]
#   kb.layout                               => [[kc, ...], ...]  (-1 = no switch)
#   kb.get_layer(:default)                  => [keycode, ...]
#   kb.send(:add_layer, :default, [kc, ...]) => updates keymap live
...
kb.layer(:fn3) do
  row IP_MACRO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINUS, KC_EQUAL, KC_LBRACKET, KC_RBRACKET, KC_BSLASH
